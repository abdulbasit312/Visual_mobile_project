...
#SBATCH --gres=gpu:1
#SBATCH --mem=20G
#SBATCH --output=training_output_t_sch.out
#SBATCH --error=training_output2_t_sch.err
...
srun python main.py --model ${MODEL} --resume /w/331/stutiwadhwa/Visual_mobile_project/classification/class_output_200classes_t/checkpoint-202.pth --data_path /w/331/abdulbasit/image-net-small/new_train --eval_data_path /w/331/abdulbasit/image-net-small/new_val --output_dir /w/331/stutiwadhwa/Visual_mobile_project/classification/class_output_200classes_t

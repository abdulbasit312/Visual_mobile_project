...
def get_args_parser():
    ...
    parser.add_argument('--lr', type=float, default=0.00003, metavar='LR',# set back 0.00005
    ...
    parser.add_argument('--warmup-epochs', type=int, default=0, metavar='N', #set back 0
    ...
    # * Mixup params
    parser.add_argument('--mixup', type=float, default=0.0, #changed
    ...
    parser.add_argument('--num_workers', default=2, type=int) #changed
